...
- **H009 (Tag names should be lowercase)**: Restricted to a specific list of common HTML tags when fully uppercase, matching `djlint`'s behavior and allowing camelCase SVG tags like `clipPath`.
- **H010 (Attribute names should be lowercase)**: Restricted to a specific list of common HTML attributes when fully uppercase, allowing camelCase SVG attributes like `viewBox`.
